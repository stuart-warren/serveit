...
func main() {
	...
	phm := middleware.NewPrometheusHttpMetric("serveit", []float64{50.0, 90.0, 95.0, 99.0, 99.999})
	...
	mux.Handle("/", rootMux)
	srv := &http.Server{Addr: ":1234", Handler: middleware.Decorate(mux, phm.For("/"), middleware.Logging())}
